	...
	return (
		<article className={styles.about}>
			...
			<p className={styles.paragraph}>
				Not actually a cowboy, but I do love a good felt hat and adventure. I&rsquo;m a Front-End Engineer at Vercel, telling the story of better development on the web. Previously, I worked at Notion, Dropbox, and Square (I really like companies with cube-shaped logos), along with time spent at an agency and freelancing.
			</p>
			<p className={styles.paragraph}>
			...
			<p className={styles.paragraph}>
				While I&rsquo;m at ease in a city like San Francisco, I&rsquo;m captivated by the unfolding beauty of the deserts in the American Southwest. Wherever I go, I take a camera with me to capture landscapes and the odd times we&rsquo;re living in (friends included).
			</p>
			<p className={styles.paragraph}>
			...
			<p className={styles.paragraph}>
				I&rsquo;m eternally optimistic about the future. Perpetual doom and gloom isn&rsquo;t something I mesh with, though I do love discourse and debate.
			</p>
		</article>
	);
}
